          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                class="btn btn-primary"
                data-dismiss="modal"
                @click="editSubmit(editItems.data.id)"
              >Submit</button>
            </div>
          </div>
        </div>
  ...
  methods: {
    ...
    submitBtn() {
      ...
      axios.post("http://127.0.0.1:880/api/add.php", data).then(res => {
        ...
        // this.items = res.data.data ; //此方法也可
      });
    },
